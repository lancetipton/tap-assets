...
export const SvgWheelchair = (props) => {
  return (
    <SvgIcon
      {...props}
      viewBox={"0 0 50 50"}
      delta={
        "M16.783 9c2.219 0 4-1.805 4-4 0-2.219-1.781-4-4-4-2.206 0-4 1.782-4 4 0 2.195 1.794 4 4 4zm2.824 36.675c-6.812 0-12.336-5.601-12.336-12.537 0-3.797 1.689-7.185 4.324-9.489l-.219-3.922C6.964 22.529 4 27.458 4 33.138 4 41.89 10.983 49 19.607 49 25.953 49 31.562 44.529 34 39l-2.376-3.272c-1.174 5.665-6.09 9.947-12.017 9.947zM44 38h-2l-8-11c-.433-.761-2-3-4-3h-9v-4h8c1.036 0 2.154-.441 2.154-1.506C31.154 17.437 30.065 17 29 17h-8v-4c-.147-2.218-2-3-3.99-2.954C15 10.092 14 11 14 13v14c.19 2.246 1.807 3 4 3h12l7 9c.451.746 2 3 2 3h5c1.032 0 2-.938 2-2 0-1.057-.936-2-2-2z"
      }
    />
  );
};
